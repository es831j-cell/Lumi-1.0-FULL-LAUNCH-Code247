...
public final class MainActivity extends Activity {
    ...
    private void certifyIfPending() {
        ...
        new Thread(() -> {
            Bundle b = GuardianBridgeClient.call(this, "certify");
    ...
    private void ensureInstallerPermission() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage("Allow Lumi Guardian to install app updates. This is the Android permission Guardian needs to install future signed Lumi core APKs without APK Factory.")
