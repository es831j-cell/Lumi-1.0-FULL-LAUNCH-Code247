...
public class MainActivity extends Activity {
    ...
    void startLumiRuntime(){
        ...
        // Do not warm a brain that was implicated in the previous process death.
        if(isFastModelReady() && !isFastBrainQuarantined()) LocalBrain.warm(fastModelFile().getAbsolutePath(),512,localThreadBudget());
    ...
    boolean strongBrainAvailable(){
        return remoteBrainAvailable() || cloudBrainAvailable();
    }
    ...
    String safeConversationFallback(String userText){
        ...
        return "I don't have a reliable answer for that yet. If you connect my stronger AI booster, I can handle questions like that much better.";
    }
        ...
        LumiUpdateManager.importPackage(this,prefs,uri,new LumiUpdateManager.Listener(){
            ...
            @Override public void onComplete(LumiUpdateManager.Result result){
                ...
                String msg=result.coreInstallReady
                        ?"Core APK verified. Android needs your approval to install the new Lumi APK."
                ...
                new AlertDialog.Builder(MainActivity.this)
                        ...
                        .setPositiveButton(result.coreInstallReady?"Install core":"OK",(d,w)->{
    ...
    void showIntegrations(){
        ...
        if(!key.isEmpty()){
            Button clear=btn("Disconnect OpenAI"); content.addView(clear); clear.setOnClickListener(v->{SecretStore.clear(prefs,"openai_api_key"); previousResponseId=null; showIntegrations();});
        }
